...
class Ui_MainWindow(object):
    def inicializarUi(self, MainWindow):
        ...
        self.bt_HomeFlor.setGeometry(QtCore.QRect(700, 5, 50, 50))
        ...
        self.lb_BemVindo.setGeometry(QtCore.QRect(750, 15, 100, 20))
        font = fontSansSerif9
        ...
        self.lb_BemVindo2.setGeometry(QtCore.QRect(750, 30, 100, 20))
        ...
        # botao janela vendas
        self.bt_MainVendas=QtWidgets.QPushButton(self.wd_menu)
        self.bt_MainVendas.setGeometry(QtCore.QRect(0, 0, 140, 40))
        self.bt_MainVendas.setFont(fontSegoe)
        self.bt_MainVendas.setCursor(
            QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.bt_MainVendas.setFocusPolicy(QtCore.Qt.NoFocus)
        self.bt_MainVendas.setAutoFillBackground(False)
        self.bt_MainVendas.setStyleSheet(styleMenu)
        self.bt_MainVendas.setFlat(True)
        self.bt_MainVendas.setObjectName("bt_MainVendas")

        # button janela produtos
        self.bt_MainProdutos = QtWidgets.QPushButton(self.wd_menu)
        self.bt_MainProdutos.setGeometry(QtCore.QRect(140, 0, 140, 40))
        self.bt_MainProdutos.setFont(fontSegoe)
        ...
        self.bt_MainProdutos.setStyleSheet(styleMenu)
        self.bt_MainProdutos.setFlat(True)
        self.bt_MainProdutos.setObjectName("bt_MainProdutos")

        # botao janela clientes
        self.bt_MainClientes=QtWidgets.QPushButton(self.wd_menu)
        self.bt_MainClientes.setGeometry(QtCore.QRect(280, 0, 140, 40))
        self.bt_MainClientes.setFont(fontSegoe)
        self.bt_MainClientes.setCursor(
            QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.bt_MainClientes.setFocusPolicy(QtCore.Qt.NoFocus)
        self.bt_MainClientes.setAutoFillBackground(False)
        self.bt_MainClientes.setStyleSheet(styleMenu)
        self.bt_MainClientes.setFlat(True)
        self.bt_MainClientes.setObjectName("bt_MainClientes")
    ...
    def translateUi(self, MainWindow):
        ...
        self.lb_BemVindo.setText(_translate("MainWindow", "Bem Vindo à"))
        self.lb_BemVindo2.setText(_translate("MainWindow", "Floricultura Vargas"))
        ...
        self.bt_MainVendas.setText(_translate("MainWindow", "Vendas"))
        ...
        self.bt_MainClientes.setText(_translate("MainWindow", "Clientes"))
