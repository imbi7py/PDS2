...
#
# janelaClientes is responsable for managing GUI elements of Customer tab
#
...
class Ui_ct_MainClientes(object):
    def setMainClientes(self, ct_MainClientes):
        ...
        self.lb_tituloClientes.setFont(fontDejavu)
        self.lb_tituloClientes.setStyleSheet("color: #959595")
        ...
        self.tx_BuscaClientes.setGeometry(QtCore.QRect(5, 5, 800, 30))
        self.tx_BuscaClientes.setFont(fontArial)
        self.tx_BuscaClientes.setFocusPolicy(QtCore.Qt.ClickFocus)
        self.tx_BuscaClientes.setStyleSheet(styleTxtEscuro)
        self.tx_BuscaClientes.setObjectName("tx_BuscaClientes")

        self.bt_BuscaClientes = QtWidgets.QPushButton(self.fr_TopoMenuClientes)
        self.bt_BuscaClientes.setGeometry(QtCore.QRect(820, 5, 30, 30))
        self.bt_BuscaClientes.setFont(fontArial)
        ...
        self.bt_AddNovoClientes = QtWidgets.QPushButton(self.fr_TopoMenuClientes)
        self.bt_AddNovoClientes.setGeometry(QtCore.QRect(857, 0, 140, 40))
        self.bt_AddNovoClientes.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.bt_AddNovoClientes.setFocusPolicy(QtCore.Qt.NoFocus)
        self.bt_AddNovoClientes.setContextMenuPolicy(QtCore.Qt.ActionsContextMenu)
        self.bt_AddNovoClientes.setStyleSheet(styleOptionButton)
        ...
        self.tb_Clientes.setStyleSheet(styleTabela)
        ...
        self.translateUiClientes(ct_MainClientes)
    ...
    def translateUiClientes(self, ct_MainClientes):
        ...
        item.setText(_translate("ct_MainClientes", "IDENTIFICAÇÃO"))
        ...
        self.bt_AddNovoClientes.setText(QtWidgets.QApplication.translate(
            "ct_MainClientes", "NOVO CLIENTE"))
